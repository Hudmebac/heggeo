...
import { MapPin, Share2, Navigation, AlertTriangle, Palette, TimerIcon, Globe, Volume2, Settings2 } from 'lucide-react';
        ...
        <div className="flex-grow overflow-y-auto pr-2 space-y-4 py-4">
          <Accordion type="single" collapsible className="w-full">
            <AccordionItem value="geo-dropping">
              ...
              <AccordionContent className="text-sm space-y-2 pl-2">
                ...
                <ol className="list-decimal list-inside space-y-1">
                  ...
                  <li>Use the 'Geo Lifespan' slider to set how long your Geo will be active (from {String.fromCharCode(0x7B)}MIN_LIFESPAN_MINUTES{String.fromCharCode(0x7D)} to {String.fromCharCode(0x7B)}MAX_LIFESPAN_MINUTES{String.fromCharCode(0x7D)} minutes).</li>
            ...
            <AccordionItem value="active-geo-sharing">
              ...
              <AccordionContent className="text-sm space-y-2 pl-2">
                ...
                <ol className="list-decimal list-inside space-y-1">
                  ...
                  <li>You can (optionally) attach a photo:
                    <ul className="list-disc list-inside ml-4">
                        <li>Click 'Open Camera' to use your device's camera, then 'Capture Photo'.</li>
                        <li>Click 'Upload Photo' to select an image file from your device.</li>
                    </ul>
                  </li>
                  <li>If a photo is attached, an AI will generate a brief description of it.</li>
                  <li>Click the 'Share' button in the dialog.</li>
                  <li>This will open WhatsApp with a pre-filled message. The message includes:
                    <ul className="list-disc list-inside ml-4">
                        ...
                        <li>The AI-generated image description (if a photo was attached).</li>
            ...
            <AccordionItem value="journey-tracker">
              ...
              <AccordionContent className="text-sm space-y-2 pl-2">
                ...
                <ol className="list-decimal list-inside space-y-1">
                  ...
                  <li>This feature uses OpenStreetMap Nominatim for geocoding (finding coordinates from addresses) and OSRM for route calculation.</li>
                </ol>
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="alarm-mode">
              ...
              <AccordionContent className="text-sm space-y-2 pl-2">
                ...
                <ul className="list-disc list-inside space-y-1">
                  ...
                  <li>This will play a siren for {String.fromCharCode(0x7B)}INSTANT_ALARM_DURATION_SECONDS{String.fromCharCode(0x7D)} seconds at maximum volume ({String.fromCharCode(0x7B)}DEFAULT_SIREN_TYPE{String.fromCharCode(0x7D)} wave).</li>
                </ul>
                ...
                <ol className="list-decimal list-inside space-y-1">
                  ...
                  <li><strong><TimerIcon className="inline h-4 w-4" /> Duration:</strong> Adjust the slider to set how long the alarm will sound (from {String.fromCharCode(0x7B)}MIN_CONFIG_DURATION_SECONDS{String.fromCharCode(0x7D)} to {String.fromCharCode(0x7B)}MAX_CONFIG_DURATION_SECONDS{String.fromCharCode(0x7D)} seconds).</li>
            ...
            <AccordionItem value="theme-switcher">
              ...
              <AccordionContent className="text-sm space-y-2 pl-2">
                <p>Change the app's appearance to suit your preference.</p>
                <ol className="list-decimal list-inside space-y-1">
                  <li>Locate the theme switcher icon (Sun for Light, Moon for Dark, Contrast for High Contrast modes) in the header, typically on the right side.</li>
                  <li>Click the icon to open a dropdown menu.</li>
                  <li>Select from the available themes:
                    <ul className="list-disc list-inside ml-4">
                      <li>Light (Default)</li>
                      <li>Dark</li>
                  ...
                  <li>The application's theme will update immediately.</li>
                  <li>Your theme preference is saved in your browser and will be applied on your next visit.</li>
                </ol>
              </AccordionContent>
            </AccordionItem>
          </Accordion>
